...
<div id="content">Once you have created an image then you can use this image exactly as if it were the original disc, the only limitation being that it will be read only.
